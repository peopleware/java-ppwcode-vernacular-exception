 ...
 *   nor the administrator, but <em>we our self, the developers</em>.</p>
 *
 ...
 *
 * <p>Note: In draft versions of this vernacular, we introduced a separate {@code AssertionError} for
 ...
 *   Applying Occam's Razor, the specialized {@code AssertionError} hence disappeared.</p>
 *
 * @author    Jan Dockx
...
public final class ProgrammingErrorHelpers {
  ...
  public static AssertionError newAssertionError(String message, Throwable t) {
    return new AssertionError(message, t);
  }
  ...
  */
  ...
  /**
   * <p>Use in a code branch ({@code if}, {@code else}, {@code default}, ...) that should never be reached if
   * the code is correct. For dead {@code catch} clauses, see {@link #unexpectedException(Throwable, String)}.</p>
   * <p>Usage:</p>
   * <pre>
   * ...
   * else {
  ...
  */
   ...
   * <p>{@code UNEXPECTED_EXCEPTION_MESSAGE == }{@value}</p>
   */
  public static final String UNEXPECTED_EXCEPTION_MESSAGE = "An unexpected exception occurred.";
