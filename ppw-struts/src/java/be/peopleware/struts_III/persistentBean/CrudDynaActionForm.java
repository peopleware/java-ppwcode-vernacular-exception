...
import be.peopleware.persistence_I.IdFormatException;
...
public abstract class CrudDynaActionForm extends DynaActionForm {
   ...
   *
   * @see       #initBean()
   * @see       #formToBean(AsyncCrudDao)
   * @see       #getIdFromForm()
   *
   * @pre       getPersistentBean() != null;
   */
  protected abstract void beanToForm(final AsyncCrudDao asyncCRUD)
   ...
   */
  protected abstract void formToBean(final AsyncCrudDao asyncCRUD)
